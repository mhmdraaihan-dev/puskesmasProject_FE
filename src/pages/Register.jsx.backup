            ...
            <div className="auth-shell auth-shell--wide">
                <div className="auth-card">
                    <div className="auth-header">
                        <div className="auth-eyebrow">Account Setup</div>
                        <h2 className="auth-title">Create Account</h2>
                        <p className="auth-subtitle">
                            Lengkapi data akun untuk akses ke sistem Puskesmas. Tampilan dirapikan tanpa mengubah alur registrasi yang sudah ada.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="auth-grid">
