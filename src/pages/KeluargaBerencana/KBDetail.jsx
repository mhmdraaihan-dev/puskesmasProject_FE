...
import { getKBDetail, verifyKB, deleteKB } from "../../services/api";
import { useAuth } from "../../context/AuthContext";
import StatusBadge from "../../components/StatusBadge";
import ConfirmDialog from "../../components/ConfirmDialog";
import { formatDate } from "../../utils/dateFormatter";
import { canEditKB, canDeleteKB, canVerifyKB } from "../../utils/roleHelpers";
import "../../App.css";
  ...
  return (
    <div className="dashboard">
      ...
      >
        ...
        >
          <div>
            <h2 style={{ marginBottom: "0.25rem" }}>Detail KB</h2>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontWeight: "bold", color: "var(--accent-color)" }}>
                {data.alat_kontrasepsi?.replace(/_/g, " ")}
              </p>
            </div>
            <div>
              <label className="text-muted" style={{ fontSize: "0.875rem" }}>
              ...
              <p style={{ color: data.at ? "#ef4444" : "inherit" }}>
          ...
          >
            ...
            <div>
              ...
              <p>Laki-laki: {data.jumlah_anak_laki}</p>
              <p>Perempuan: {data.jumlah_anak_perempuan}</p>
            </div>
          </div>
        </div>
