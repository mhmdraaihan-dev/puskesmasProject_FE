...
const ResetPassword = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            alert(`Password untuk ${targetUser?.full_name || 'user'} berhasil direset!`);
            navigate('/');
        } catch (err) {
    ...
    return (
        <div className="dashboard">
            <div className="dashboard-header">
                <div>
                    ...
                    <p className="text-muted">
                        {targetUser ? `Reset password untuk: ${targetUser.full_name}` : 'Reset user password'}
                    </p>
                </div>
                <div>
            ...
            <div className="auth-card" style={{ maxWidth: '500px', margin: '0 auto' }}>
                {!isAdmin && (
                    <div style={{ background: 'rgba(251, 191, 36, 0.2)', border: '1px solid rgba(251, 191, 36, 0.4)', color: '#fbbf24', padding: '1rem', borderRadius: '8px', marginBottom: '1rem' }}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div style={{ marginTop: '1rem', padding: '1rem', background: 'rgba(239, 68, 68, 0.1)', borderRadius: '8px', border: '1px solid rgba(239, 68, 68, 0.3)' }}>
                        ...
                        <ul style={{ fontSize: '0.875rem', marginTop: '0.5rem', paddingLeft: '1.5rem', color: '#fca5a5' }}>
