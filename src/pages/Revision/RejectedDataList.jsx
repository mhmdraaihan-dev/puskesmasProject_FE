        ...
        <div className="dashboard">
            ...
            {loading ? (
                ...
                <div className="auth-card" style={{ textAlign: 'center', padding: '3rem' }}>
                    <p style={{ color: 'var(--text-muted)' }}>Tidak ada data yang ditolak</p>
                </div>
            ) : (
                    ...
                    {rejectedData.map((data) => (
                        <div key={data.data_id} className="auth-card">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '1rem', fontSize: '0.875rem' }}>
                                ...
                                <div>
                                    <p style={{ color: 'var(--text-muted)', marginBottom: '0.25rem' }}>Ditolak Oleh</p>
                                    <p>{data.verifier?.full_name || '-'}</p>
                                </div>
                                <div>
                                    <p style={{ color: 'var(--text-muted)', marginBottom: '0.25rem' }}>Tanggal Ditolak</p>
                            ...
                            <div style={{
                                ...
                                <p style={{ fontSize: '0.75rem', color: '#fca5a5', marginBottom: '0.5rem', fontWeight: '600' }}>
                                    ⚠️ ALASAN PENOLAKAN:
                                </p>
