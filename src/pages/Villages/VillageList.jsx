...
const VillageList = () => {
    ...
    const [deleteDialog, setDeleteDialog] = useState({ isOpen: false, villageId: null, villageName: '' });
        ...
        <div className="dashboard">
            <div className="dashboard-header">
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <RoleGuard allowedRoles={['ADMIN']}>
                        <button onClick={() => navigate('/villages/add')} className="btn-primary">
                            + Tambah Desa
                        </button>
                    </RoleGuard>
                </div>
            ...
            {loading ? (
                ...
                <div className="auth-card" style={{ textAlign: 'center', padding: '3rem' }}>
                    ...
                    <RoleGuard allowedRoles={['ADMIN']}>
                        <button onClick={() => navigate('/villages/add')} className="btn-primary" style={{ marginTop: '1rem' }}>
                            Tambah Desa Pertama
                        </button>
                    </RoleGuard>
                </div>
                    ...
                    {villages.map((village) => (
                        <div key={village.village_id} className="auth-card">
                            <div style={{ marginBottom: '1rem' }}>
                                <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>{village.nama_desa}</h3>
                            ...
                            <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                                ...
                                <RoleGuard allowedRoles={['ADMIN']}>
                                    ...
                                    <button
                                        onClick={() => setDeleteDialog({ isOpen: true, villageId: village.village_id, villageName: village.nama_desa })}
                                        className="btn-primary"
                                        style={{
                                            flex: 1,
                                            padding: '0.5rem',
            ...
            <ConfirmDialog
                ...
                onClose={() => setDeleteDialog({ isOpen: false, villageId: null, villageName: '' })}
