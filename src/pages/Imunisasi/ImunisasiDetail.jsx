  ...
  return (
    <div className="dashboard">
      <div className="dashboard-header" style={styles.header}>
        <div>
          <h2 style={styles.pageTitle}>Detail Imunisasi</h2>
      ...
      <div className="auth-card" style={styles.heroCard}>
        ...
        <div style={styles.summaryGrid}>
          <div style={styles.summaryItem}>
            <span style={styles.summaryLabel}>Jenis Imunisasi</span>
            <span style={styles.summaryValue}>
              {formatImmunizationType(data.jenis_imunisasi)}
            </span>
          </div>
          <div style={styles.summaryItem}>
            <span style={styles.summaryLabel}>Berat Badan</span>
            <span style={styles.summaryValue}>{data.berat_badan} kg</span>
          </div>
          <div style={styles.summaryItem}>
            <span style={styles.summaryLabel}>Suhu Badan</span>
            <span style={styles.summaryValue}>
          ...
          <div style={styles.summaryItem}>
            <span style={styles.summaryLabel}>Nama Orang Tua</span>
            <span style={styles.summaryValue}>{data.nama_orangtua || "-"}</span>
          </div>
        </div>
      </div>
      ...
      <div style={styles.contentGrid}>
        <div className="auth-card" style={styles.sectionCard}>
          <div style={styles.sectionHeader}>
            <h3 style={styles.sectionTitle}>Ringkasan Pelayanan Imunisasi</h3>
          ...
          <div style={styles.detailGrid}>
            <div style={styles.detailItem}>
              <span style={styles.detailLabel}>Tanggal Imunisasi</span>
              <span style={styles.detailValue}>{formatDate(data.tgl_imunisasi)}</span>
            </div>
            <div style={styles.detailItem}>
            ...
            <div style={styles.detailItem}>
              <span style={styles.detailLabel}>Kondisi Anak</span>
              <span style={styles.detailValue}>
                {data.berat_badan} kg / {data.suhu_badan ?? "-"} C
              </span>
            </div>
            <div style={styles.detailItem}>
              <span style={styles.detailLabel}>Orang Tua</span>
              <span style={styles.detailValue}>{data.nama_orangtua || "-"}</span>
            </div>
          </div>

          <div style={styles.noteCard}>
            <span style={styles.detailLabel}>Catatan</span>
            <p style={styles.noteText}>{data.catatan || "Tidak ada catatan"}</p>
          </div>
        </div>
      ...
      {showRejectModal ? (
        <div style={styles.modalOverlay}>
          <div className="auth-card" style={styles.modalCard}>
            <h3 style={styles.modalTitle}>Tolak Data Imunisasi</h3>
