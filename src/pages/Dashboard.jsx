        ...
        <div className="dashboard">
            <header className="dashboard-header">
                ...
                <div className="header-user-info">
                    ...
                    <button onClick={logout} className="btn-primary" style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--glass-border)' }}>
                        Logout
                    </button>
                </div>
            </header>
            ...
            <div style={{ marginBottom: '2rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '1rem' }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', margin: 0 }}>Kelola data desa</p>
                    </button>
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', margin: 0 }}>Kelola tempat praktik bidan</p>
                    </button>
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', margin: 0 }}>Kelola data kesehatan pasien</p>
                    </button>
                    ...
                    {user?.position_user === 'bidan_desa' && (
                        ...
                        >
                            ...
                            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', margin: 0 }}>Data menunggu verifikasi</p>
                        </button>
                    )}
                    ...
                    {user?.position_user === 'bidan_praktik' && (
                        ...
                        >
                            ...
                            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', margin: 0 }}>Data yang perlu direvisi</p>
                        </button>
                    )}
                </div>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                ...
                <button onClick={() => navigate('/add-user')} className="btn-primary" style={{ width: 'auto' }}>
                    + Add New User
                </button>
            </div>
                        ...
                        <div key={u.user_id} className="user-card">
                            ...
                            <div style={{ marginTop: '1rem', fontSize: '0.9rem' }}>
                                <p className="text-muted" style={{ marginBottom: '0.5rem' }}>
                                    <span style={{ display: 'inline-block', width: '20px' }}>📧</span> {u.email}
                                </p>
                                <p className="text-muted" style={{ marginBottom: '0.5rem' }}>
                                    <span style={{ display: 'inline-block', width: '20px' }}>📍</span> {u.address}
                                </p>
                                <p className="text-muted" style={{ marginBottom: '0.5rem' }}>
                                    <span style={{ display: 'inline-block', width: '20px' }}>💼</span> {u.position_user?.replace('_', ' ') || '-'}
                                </p>
                            </div>

                            <div style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            fontSize: '0.75rem',
                                            width: 'auto',
                                            backgroundColor: u.status_user === 'ACTIVE' ? 'rgba(239, 68, 68, 0.3)' : 'rgba(16, 185, 129, 0.3)',
