    ...
    <div className="dashboard page-shell" style={styles.page}>
      <header className="dashboard-header no-print" style={styles.header}>
        <div className="page-intro">
          <div className="page-kicker">Approved Feed Report</div>
          <h1 className="page-title" style={styles.pageTitle}>Rekapitulasi Pelayanan</h1>
          <p className="page-subtitle" style={styles.pageSubtitle}>
            Laporan bulanan data pelayanan berstatus approved
          </p>
        </div>
        <div className="page-actions" style={styles.headerActions}>
          <button onClick={() => navigate("/")} className="btn-secondary" style={styles.secondaryButton}>Kembali</button>
          <button onClick={handleOpenExport} className="btn-secondary" style={styles.infoButton} disabled={exportLoading}>{exportLoading ? "Exporting..." : "Export Data"}</button>
          <button onClick={() => window.print()} className="btn-primary" style={styles.successButton}>Cetak Laporan</button>
        </div>
      </header>

      <div style={styles.summaryGrid}>
        <div className="stat-card no-print" style={styles.summaryCard}><span style={styles.summaryLabel}>Modul Aktif</span><strong style={styles.summaryValue}>{getModuleLabel(filters.module)}</strong></div>
        <div className="stat-card no-print" style={styles.summaryCard}><span style={styles.summaryLabel}>Periode</span><strong style={styles.summaryValue}>{getMonthLabel(filters.month)} {filters.year}</strong></div>
        <div className="stat-card no-print" style={styles.summaryCard}><span style={styles.summaryLabel}>Wilayah</span><strong style={styles.summaryValue}>{selectedVillageName}</strong></div>
        <div className="stat-card no-print" style={styles.summaryCard}><span style={styles.summaryLabel}>Total Data / Catatan</span><strong style={styles.summaryValue}>{stats.total} / {stats.notes}</strong><span className="text-muted" style={styles.summaryHelper}>Praktik terlibat: {stats.practitioners}</span></div>
      </div>

      <div className="content-card-light no-print" style={styles.filterCard}>
      ...
      <div className="content-card-light print-area" style={styles.tableCard}>
...
const styles = {
  page: { maxWidth: "1240px", paddingBottom: "3rem" },
  header: { gap: "1rem", flexWrap: "wrap", alignItems: "flex-start" },
  ...
  secondaryButton: { width: "auto", minWidth: "120px", paddingInline: "1rem" },
  infoButton: { width: "auto", minWidth: "130px", paddingInline: "1rem", backgroundColor: "rgba(86, 143, 255, .1)", border: "1px solid rgba(86, 143, 255, .24)", color: "#4572bd" },
  successButton: { width: "auto", minWidth: "140px", paddingInline: "1rem", backgroundColor: "rgba(93, 184, 166, .14)", border: "1px solid rgba(93, 184, 166, .24)", color: "#236b5d" },
  dangerButton: { width: "auto", minWidth: "120px", paddingInline: "1rem", backgroundColor: "rgba(198, 69, 69, .12)", border: "1px solid rgba(198, 69, 69, .2)", color: "#a13a3a" },
  ...
  tableCard: { ...sectionSurface, padding: "1.25rem", overflowX: "auto", maxWidth: "none", borderRadius: "22px" },
